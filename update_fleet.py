                        ...
                        <div class="space-y-4 flex-grow mb-5">
                            ...
                            <div class="bg-gray-50 rounded-lg p-3 border border-gray-100 flex justify-between items-center relative mt-2">
                                ...
                                <div class="text-right">
                                    <p class="text-[10px] font-bold text-dark uppercase">Return kms chargeable</p>
                                </div>
                            </div>
                            <!-- Round Trip -->
...
# Find the grid container inside the fleet section
# It looks like: <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
...
if match:
    ...
    with open('index.html', 'w', encoding='utf-8') as f:
        f.write(new_html)
    print("Successfully updated fleet section with inline tariffs")
else:
