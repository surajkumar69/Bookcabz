...
# Fix literal newlines if they exist
html = html.replace(r'\n', '')

# Replace container
pattern_container = r'(<section id="fleet"[^>]*>\s*)<div class="(?:container )?mx-auto px-4[^"]*">'
html = re.sub(pattern_container, r'\1<div class="max-w-[1450px] mx-auto px-4">', html)
...
if match:
    ...
    with open('index.html', 'w', encoding='utf-8') as f:
        f.write(new_html)
    print("Successfully updated layout to exact reference specifications")
else:
