...
if match:
    ...
    with open('index.html', 'w', encoding='utf-8') as f:
        f.write(new_html)
    print("Successfully reverted all 3:00 PM changes completely")
else:
